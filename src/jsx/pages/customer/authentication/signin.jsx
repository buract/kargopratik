                                ...
                                <div className="card-body">
                                    <form method="post" name="myform" className="signin_validate" action="#">
                                        <div className="form-group">
                                            <label>E-Posta</label>
                                            <input type="email" className="form-control" placeholder="Lütfen kayıtlı e-posta bilginizi girin."
                                                name="email" />
                                        </div>
                                        <div className="form-group">
                                            <label>Parola</label>
                                        ...
                                        <div className="text-center">
                                            <Link to={'./otp-1'} type="submit" className="btn btn-primary btn-block">Giriş Yap</Link>
                                        </div>
                                    </form>
